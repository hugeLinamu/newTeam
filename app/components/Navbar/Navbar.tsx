...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-[250] flex h-16 justify-center border-b-2 bg-white">
      <div className="h-full w-full max-w-7xl ">
        <div className="flex h-full items-center justify-between py-2">
          ...
          <div className="relative flex w-auto items-center justify-start gap-2.5">
          ...
          <div>
            {user ? (
              <div className="flex items-center justify-between gap-4">
                <p>
                  欢迎，
                  <Link to="/user" className="text-[#62c3a5] hover:underline">
                    {user.nickname}
                  </Link>
                </p>
                {(user.role === "ADMIN" || user.role === "BUSINESS") && (
                  <Link
                    to="/manager"
                    className="hover:text-[#62c3a5] active:text-[#62c3a5]"
                  >
                    控制台
                  </Link>
                )}
                <Form action="/logout" method="post">
                  <button
                    type="submit"
                    className="py-4 px-3  hover:text-[#62c3a5] active:text-[#62c3a5]"
                  >
                    登出
                  </button>
                </Form>
